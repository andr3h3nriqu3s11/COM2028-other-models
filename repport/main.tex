...
% 
	...
	\block{\Large Block CNN}{
		...
		it provided more data to the model witch tends improve performance.
		...
		\begin{tikzfigure}[Structure of the network]
			\resizebox{.70\linewidth}{!}{
				\begin{tabular}{| c | c | c | c | c | c | c |}
					...
					Block           & 3                 & 128               &  3                   & valid   & Average          & $16\times16\times128$    \\     
					Block           & 4                 & 250               &  3                   & valid   & Average          & $8\times8\times250$      \\     
					Block           & 5                 & 500               &  3                   & valid   & Average          & $4\times4\times500$      \\     
		...
		\begin{minipage}[t]{.5\linewidth}
			\begin{tikzfigure}[Results without global average]
				\label{no-global}
				\includegraphics[width=.49\linewidth]{figures/block_cnn.png}
			\end{tikzfigure}
		\end{minipage}
		\begin{minipage}[t]{.5\linewidth}
			\begin{tikzfigure}[Results with global average]
				\label{global}
				\includegraphics[width=.48\linewidth]{figures/block_cnn_better.png}
			\end{tikzfigure}
		\end{minipage}
	}
	\block{\Large Results}{
